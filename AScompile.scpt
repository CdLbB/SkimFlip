----------------------------------------------------------------------------------------------------------------
-- This script was designed to compile "SkimFlip.scpt" and move any resources needed for the compiled applet to the "Resources" folder compiling them if required.
----------------------------------------------------------------------------------------------------------------

property scriptName : "SkimFlip"
